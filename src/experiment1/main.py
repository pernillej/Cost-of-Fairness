...
def plot():
    ...
    svm_results2 = read_result_from_file('svm_28-04-2020_16-33.txt')
    svm_results3 = read_result_from_file('svm_29-04-2020_02-05.txt')
    ...
    reweighing_results2 = read_result_from_file('svm_reweighing_28-04-2020_19-04.txt')
    reweighing_results3 = read_result_from_file('svm_reweighing_29-04-2020_04-27.txt')
    ...
    dir_results2 = read_result_from_file('svm_dir_28-04-2020_21-37.txt')
    dir_results3 = read_result_from_file('svm_dir_29-04-2020_06-53.txt')
    ...
    optimpreproc_results2 = read_result_from_file('svm_optimpreproc_28-04-2020_23-25.txt')
    optimpreproc_results3 = read_result_from_file('svm_optimpreproc_29-04-2020_08-29.txt')

    # plot_results([svm_results, svm_results1, svm_results2, svm_results3])
    # plot_results([reweighing_results, reweighing_results1, reweighing_results2, reweighing_results3])
    # plot_results([dir_results, dir_results1, dir_results2, dir_results3])
    # plot_results([optimpreproc_results, optimpreproc_results1, optimpreproc_results2, optimpreproc_results3])
