...
def svm(dataset, fairness_metric, accuracy_metric, C, gamma, keep_features, classification_threshold,
    ...
    fav_inds = dataset_orig_test_pred.scores > classification_threshold
...
def svm_reweighing(dataset, fairness_metric, accuracy_metric, C, gamma, keep_features, classification_threshold,
                   privileged_groups, unprivileged_groups):
    """
    ...
    # Assign labels using the classification threshold
    fav_inds = dataset_transf_test_pred.scores > classification_threshold
...
def svm_dir(dataset, fairness_metric, accuracy_metric, C, gamma, keep_features, classification_threshold,
            privileged_groups, unprivileged_groups):
    """
...
def svm_optimpreproc(dataset, fairness_metric, accuracy_metric, C, gamma, keep_features, classification_threshold,
                     privileged_groups, unprivileged_groups):
    """
    ...
    return svm(dataset=dataset, fairness_metric=fairness_metric, accuracy_metric=accuracy_metric, C=C, gamma=gamma,
               keep_features=keep_features, classification_threshold=classification_threshold,
