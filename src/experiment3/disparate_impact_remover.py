...
from src.experiment3.algorithms import train_svm_dir, test_classifier
...
def svm_dir_experiment(classifier_chromosome, num_generations, population_size, mutation_rate, crossover_rate,
