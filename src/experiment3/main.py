...
def plot():
    svm_results = read_result_from_file('svm_25-04-2020_12-52.txt')
    reweighing_results = read_result_from_file('svm_reweighing_25-04-2020_12-56.txt')
    dir_results = read_result_from_file('svm_dir_25-04-2020_12-59.txt')
    optimpreproc_results = read_result_from_file('svm_optimpreproc_25-04-2020_13-02.txt')
