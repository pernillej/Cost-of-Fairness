...
from src.experiment3.algorithms import train_svm_optimpreproc, test_classifier
...
def svm_optimpreproc_experiment(classifier_chromosome, num_generations, population_size, mutation_rate,
    ...
    result_summary = {'name': 'SVM_OptimPreProc',
                      ...
                      'nsga2_parameters': {'num_generations': num_generations, 'population_size': population_size,
                                           ...
                                           'chromosome_length': chromosome_length}}
    write_result_to_file(result_summary, "svm_optimpreproc_" + name_postfix)
