...
def evaluation_function(chromosome):
    ...
    Contains the svm_roc algorithm, that returns the fitness scores for the specified metrics.
    ...
    if str(chromosome) in FITNESS_SCORES:
        ...
        accuracy_score, fairness_score = svm_ROC(DF, METRICS, DF_ATTRIBUTES, C=C, gamma=gamma,
