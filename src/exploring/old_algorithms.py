from src.exploring.old_data import get_privileged_and_unprivileged_groups, dataframe_to_dataset, to_dataframe
...
def svm_reweighing1(data, metrics, data_attributes, C, gamma, drop_features, k=5):
    """
...
def svm_dir1(data, metrics, data_attributes, C, gamma, repair_level, drop_features, k=5):
    kf = KFold(n_splits=k, shuffle=True)
    accuracy_scores = []
    fairness_scores = []
